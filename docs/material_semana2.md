...
**Resposta:** 2 × 10⁵ Pa (dobro da pressão atmosférica)
...
**Resposta:** Para evitar formação de bolhas de gás no sangue.
...
**Resposta:** 2 Al + 6 HCl → 2 AlCl₃ + 3 H₂
...
**Resposta:** Liberação de gás (efervescência)
...
**Resposta:** Reação de decomposição
...
**Resposta:** 3,14 m (aproximadamente π metros)
...
**Resposta:** Flutua com 60% do volume submerso
...
**Resposta:** 30 N (a pedra "pesa menos" dentro d'água!)
...
**Resposta:** Catetos de 5 cm e 5√3 cm
...
**Resposta:** 60% submerso, 40% emerso
...
**Resposta:** -20 N (sobe com força resultante de 20 N para cima)
...
**Resposta:** A Lei de Dalton é verificada (proporção 2:3)
...
**Resposta:** Lei de Dalton (Proporções Múltiplas) - verificada com razão 1:2
...
**Resposta:** Tempo é o estado momentâneo da atmosfera (curto prazo), clima é o padrão médio das condições atmosféricas (longo prazo, 30+ anos).

#### Exercício 2
Por que regiões de grande altitude têm temperaturas mais baixas?

**Resposta:** Ar rarefeito retém menos calor; a cada 100-200m de altitude, temperatura cai ~1°C.

#### Exercício 3
Qual a diferença entre maritimidade e continentalidade?

**Resposta:** Maritimidade (proximidade do mar) resulta em menor amplitude térmica e maior umidade. Continentalidade (distância do mar) resulta em maior amplitude térmica e menor umidade.

#### Exercício 4
Quais são os três tipos de chuva?

**Resposta:** Convectiva (aquecimento do solo), orográfica (relevo), frontal (encontro de massas de ar).

#### Exercício 5
(UFMG) Por que o litoral tem clima mais ameno que o interior?

**Resposta:** Maritimidade - oceano modera temperaturas devido ao alto calor específico da água, reduzindo amplitude térmica.
...
**Resposta:** Procariótica não tem núcleo definido nem organelas membranosas (ex: bactérias). Eucariótica tem núcleo definido e organelas (ex: células animais e vegetais).
...
**Resposta:** b) Uma população (mesma espécie, mesma área)

#### Exercício 4
Defina ecossistema.

**Resposta:** Conjunto da comunidade (seres vivos) interagindo com fatores abióticos (água, solo, clima, etc.).

#### Exercício 5
Qual a diferença entre população e comunidade?

**Resposta:** População = mesma espécie na mesma área. Comunidade = várias espécies (várias populações) na mesma área.

#### Exercício 6
O que são propriedades emergentes?

**Resposta:** Características que surgem apenas em determinado nível de organização, não existindo nos níveis inferiores. Ex: vida surge na célula, não em organelas isoladas.

#### Exercício 7
Coloque em ordem crescente de organização: tecido, célula, organismo, órgão, organela.

**Resposta:** Organela → Célula → Tecido → Órgão → Organismo
