...
#+LATEX_HEADER: \fancyhead[R]{Semana 3 - Conteúdo Avançado (03-07 Dez)}
...
- Áreas de Figuras (Parte 1)
- 120min
*** Introdução à Geometria Plana
*Geometria Plana:* estuda figuras bidimensionais (2D)
- polígonos, círculos, etc.
...
*Exemplo:* Retângulo com b = 8 cm e h = 5 cm
- A = 8 × 5 = 40 cm²
- P = 2(8 + 5) = 26 cm
...
*Exemplo:* Paralelogramo com b = 10 cm e h = 4 cm
- A = 10 × 4 = 40 cm²
...
*Exemplo:* Trapézio com B = 12 cm, b = 8 cm, h = 5 cm
...
*Exemplo:* Losango com D = 10 cm e d = 6 cm
- A = (10 × 6) / 2 = 30 cm²
...
- Evidências, Equações e Balanceamento
- 90min
...
- base para estequiometria)

--------------

** Aula 47
- Geografia: Estrutura Geológica, Relevo, Tectônica e Mineração
- 60min
...
- Exemplo: Himalaia (Índia + Eurásia)
- Monte Everest!
...
- Tipos:
- *Intrusivas (plutônicas):* magma esfria lentamente no interior
- cristais grandes
- Exemplo: granito
- *Extrusivas (vulcânicas):* magma esfria rapidamente na superfície
- cristais pequenos
- Exemplo: basalto
...
- tópico recorrente em Geografia física)

--------------

** Aula 48
- Ciências Humanas: Antiguidade Tardia e Mundo Medieval
- 60min
...
- *Hunos:* (não germânicos) vindos da Ásia
- Átila
...
*Legalização:*
- *313 d.C.
- Édito de Milão* (Constantino): liberdade religiosa
- *380 d.C.
- Édito de Tessalônica* (Teodósio): cristianismo como *religião oficial*
...
*Clero:*
- *Secular:* vive no “século” (mundo)
- padres, bispos, papa
- *Regular:* segue regra (ordem religiosa)
- monges em mosteiros
...
*Tempo de estudo recomendado:* 60 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐ (muito importante
- base para entender história medieval)
...
** Aula 49
- Matemática: Geometria Plana
- Triângulos, Círculos e Teorema de Pitágoras
- 120min
*** Triângulos
...
** Aula 50
- Física: Princípio de Pascal, Teorema de Stevin e Princípio de Arquimedes
- 90min
...
*Exemplo:* Três recipientes com formas diferentes, mesma altura de água (h = 2 m):
...
*Mais abundantes (96%):*
- *C (Carbono):* 18%
- base das moléculas orgânicas
- *O (Oxigênio):* 65%
- na água e compostos orgânicos
- *H (Hidrogênio):* 10%
- na água e compostos orgânicos
- *N (Nitrogênio):* 3%
...
ELEMENTOS:
C
- Carbono (base orgânica)
O
- Oxigênio (água)
H
- Hidrogênio (água, orgânicos)
N
- Nitrogênio (proteínas, DNA)
P
- Fósforo (ATP, DNA)
#+end_example
...
*Tempo de estudo recomendado:* 120 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- base para trigonometria avançada)

--------------

** Aula 54
- Física: Princípio de Arquimedes Aprofundado e Teorema de Torricelli
- 90min
...
*Exemplo:* Pedra de 100 N no ar sofre empuxo de 30 N na água. P_aparente = 100
- 30 = 70 N
...
V_submerso = 0,898 × 1000 = 898 m³ V_emerso = 1000
- 898 = 102 m³
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- conceitos fundamentais de hidrostática)
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- tipo de questão muito comum!)

--------------

** Aula 56
- Ciências Humanas: Renascimento Cultural e Científico
- 60min
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- conversões aparecem em todas as matérias!)

--------------

** Aula 58
- Física: Revisão de Cinemática (MRU, MRUV, Queda Livre, Lançamentos)
- 90min
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- revisão completa de cinemática!)

--------------

** Aula 59
- Química: Leis Estequiométricas (Leis Ponderais)
- 90min
...
**** Exercício 4
(UFMG
- Lei de Dalton) O enxofre forma com o oxigênio dois compostos: SO₂ e SO₃. Em SO₂, 32 g de S combinam com 32 g de O. Em SO₃, 32 g de S combinam com 48 g de O. Verifique a Lei de Dalton.
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- base da estequiometria e cálculos!)
...
*Tempo de estudo recomendado:* 60 minutos *Nível de dificuldade:* Fácil-Médio *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- conceitos fundamentais!)

--------------

* 12/07
- Semana 2, Dia 5 (Sábado
- Checkpoint)
** Checkpoint Semanal
- Semana 2 (03/12
- 06/12)
...
*75.* Lei de Dalton (Proporções Múltiplas)
- verificada com razão 1:2
...
*80.* Maritimidade
- oceano modera temperaturas devido ao alto calor específico da água, reduzindo amplitude térmica.
...
*** Terça 03/12 (5 aulas)
✅ Matemática
- Geometria Plana: Áreas (triângulos, círculos, polígonos) ✅ Física
- Hidrostática: Pressão, densidade, Stevin ✅ Química
- Reações Químicas: Tipos, balanceamento ✅ Geografia
- Estrutura Geológica: Placas tectônicas, relevo ✅ Humanas
- Antiguidade Tardia e Mundo Medieval

*** Quarta 04/12 (4 aulas)
✅ Matemática
- Geometria: Triângulos especiais, círculos, Pitágoras ✅ Física
- Pascal, Stevin, Arquimedes (Hidrostática avançada) ✅ Química
- Estequiometria: Conceito de mol e massa molar ✅ Biologia
- Composição Química dos Seres Vivos

*** Quinta 05/12 (4 aulas)
✅ Matemática
- Trigonometria no Triângulo Retângulo ✅ Física
- Arquimedes aprofundado + Torricelli ✅ Química
- Estequiometria: Cálculos estequiométricos ✅ Humanas
- Renascimento Cultural e Científico

*** Sexta 06/12 (5 aulas)
✅ Matemática
- Unidades de Medida e Conversões ✅ Física
- Revisão de Cinemática (MRU, MRUV, queda livre) ✅ Química
- Leis Estequiométricas (Lavoisier, Proust, Dalton) ✅ Geografia
- Climatologia ✅ Biologia
...
✅ *O que fazer agora:* 1. Revise as fórmulas essenciais acima 2. Refaça exercícios que errou 3. Continue com as próximas aulas de revisão 4. Descanse bem
- seu cérebro precisa consolidar!
...
** Aula 62
- Matemática: Revisão de Funções Exponenciais e Logarítmicas
- 90min
*** Objetivo da Revisão
...
** Aula 63
- Matemática: Questões Discursivas e Resoluções Detalhadas
- 90min
*** Objetivo
...
*** Questão 4
- Função Exponencial (Médio-Difícil)
*Enunciado:*
...
*** Questão 5
- Logaritmo (Médio-Difícil)
*Enunciado:*

Resolva a equação: log₂ x + log₂ (x
- 6) = 4
...
*Para x = 8:*
- Condição x > 6: 8 > 6 ✓
- Substituindo na equação original: =log₂ 8 + log₂ (8
- 6) = log₂ 8 + log₂ 2   = log₂ 2³ + log₂ 2   = 3 + 1 = 4 ✓=
...
*** Questão 6
- Estequiometria Integrada (Difícil)
*Enunciado:*
...
*Pontuação parcial:* Mesmo que você erre a resposta final, pode ganhar pontos por:
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- questões discursivas valem muito!)
