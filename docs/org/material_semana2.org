...
#+LATEX_HEADER: \fancyhead[R]{Semana 2 - Período de Férias - Aprofundamento (26 Nov - 02 Dez)}
...
- Parte 2 (Zeros, Máximo/Mínimo, Estudo do Sinal)
- 90min
...
*Exemplo 2:* Resolver: -x² + 4x
- 3 ≥ 0

*Passo 1: Raízes* -x² + 4x
- 3 = 0 Multiplicando por -1: x²
- 4x + 3 = 0 (x
- 1)(x
- 3) = 0 x₁ = 1, x₂ = 3
...
**** Exercício 1
Determine o valor máximo de f(x) = -2x² + 8x
- 6.
...
**** Exercício 2
Para quais valores de x a função f(x) = x²
- 6x + 8 é negativa?

*Solução:*

*Raízes:* Δ = 36
- 32 = 4 x = (6 ± 2)/2 x₁ = 2, x₂ = 4
...
**** Exercício 4
(UFMG) Qual a imagem da função f(x) = x²
- 4x + 5?
...
**** Exercício 5
Determine para quais valores de k a função f(x) = x²
- 6x + k tem valor mínimo igual a 1.
...
- Tende a *perder 1 e⁻* → Na⁺ (2, 8)
- estável

*Cloro (Cl, Z = 17):*
- Distribuição: 2, 8, 7
- 7 elétrons na valência
- Tende a *ganhar 1 e⁻* → Cl⁻ (2, 8, 8)
- estável
...
*Resposta:*
- *Na (2,8,1):* perde 1 elétron → Na⁺ (2,8)
- cátion
- *Cl (2,8,7):* ganha 1 elétron → Cl⁻ (2,8,8)
- ânion
...
*Tempo de estudo recomendado:* 30 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐ (muito importante
...
*Bhaskara:* Δ = 16
- 8 = 8 x = (4 ± √8)/2 = (4 ± 2√2)/2 = 2 ± √2

x₁ = 2 + √2 x₂ = 2
- √2

*Encontrar y:* y₁ = 2(2 + √2) + 1 = 5 + 2√2 y₂ = 2(2
- √2) + 1 = 5
- 2√2
...
t₁ = 2
- √5 ≈ -0,24 s (descartado: negativo) t₂ = 2 + √5 ≈ 4,24 s ✓
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- inequações sempre caem!)

** Aula 33
- Química: Ligações Químicas
- Parte 2 (Ligação Covalente)
- 30min
...
*Tempo de estudo recomendado:* 30 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- ligação covalente é fundamental!)

* 11/28
- Férias Dia 3
** Aula 34
- Matemática: Função Exponencial
- Parte 1 (Potenciação e Propriedades)
- 90min
...
- função exponencial é muito cobrada!)

** Aula 35
- Química: Ligações Químicas
- Parte 3 (Ligação Metálica)
- 30min
*** Revisão: Ligações Químicas
Já estudamos:
...
*Característica:*
- Maioria são *sólidos* à temperatura ambiente (exceto Hg
- mercúrio)
...
*Exemplos:*
- *Altos PF:* W (tungstênio)
- 3422°C
- *Baixos PF:* Hg (mercúrio)
- líquido (-39°C), Ga (gálio)
- 30°C
...
*Tempo de estudo recomendado:* 30 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐ (importante
- completa o estudo de ligações!)

* 11/29
- Férias Dia 4
** Aula 36
- Matemática: Função Exponencial
- Parte 2 (Equações, Gráficos e Crescimento)
- 90min
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- aplicações são muito cobradas!)

** Aula 37
- Física: Forças Especiais
- Peso, Normal e Atrito (Revisão e Aprofundamento)
- 30min
...
*Exemplo:* Empurrando caixa com força crescente:
...
*Tempo de estudo recomendado:* 30 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐ (muito importante
- forças são essenciais!)

* 11/30
- Férias Dia 5
** Aula 38
- Matemática: Função Logarítmica
- Parte 1 (Definição e Logaritmo Decimal/Natural)
- 90min
...
**** Exercício 4
Para quais valores de x existe log₂ (x
- 3)?
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- logaritmos são fundamentais!)

** Aula 39
- Física: Plano Inclinado
- 30min
*** Introdução
...
*Tempo de estudo recomendado:* 30 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐ (muito importante
- aplicação prática de forças!)

* 12/01
- Férias Dia 6
** Aula 40
- Matemática: Função Logarítmica
- Parte 2 (Propriedades e Equações)
- 90min
...
*Verificação de condições:* 2x
- 3 > 0 → x > 3/2 ✓ x + 1 > 0 → x > -1 ✓ x = 4 satisfaz ambas

/[Ver resposta 37 no final do documento]/

**** Tipo 3: Equações com Propriedades
*Exemplo 1:* log x + log (x
- 3) = 1
...
*Solução:* log [x(x + 3)] = 1 x² + 3x = 10 x² + 3x
- 10 = 0 (x + 5)(x
- 2) = 0
...
*Método 1
- Definição:* 8^x = 2 (2³)^x = 2¹ 2^(3x) = 2¹ 3x = 1 x = 1/3

*Método 2
- Mudança de base:* log₈ 2 = (log 2)/(log 8) = (log 2)/(log 2³) = (log 2)/(3 log 2) = 1/3

/[Ver resposta 45 no final do documento]/

*** Dicas para a Prova
1. *Produto:* log(ab) = log a + log b
2. *Quociente:* log(a/b) = log a
- log b
...
*Tempo de estudo recomendado:* 90 minutos *Nível de dificuldade:* Médio-Alto *Importância para a prova:* ⭐⭐⭐⭐⭐ (essencial
- propriedades são muito cobradas!)

** Aula 41
- Química: Propriedades das Substâncias Segundo Ligações
- 30min
*** Revisão: Ligações Químicas
...
**** Características
*1. Estado Físico:*
- *Sólidos* à temp. ambiente (exceto Hg
- mercúrio)
...
*Tempo de estudo recomendado:* 30 minutos *Nível de dificuldade:* Médio *Importância para a prova:* ⭐⭐⭐⭐ (importante
- relaciona estrutura e propriedades!)

* 12/02
- Férias Dia 7 (ÚLTIMO DIA DE FÉRIAS!)
** Aula 42
- Matemática: Relação entre Funções Exponencial e Logarítmica
- 60min
*** Funções Inversas
