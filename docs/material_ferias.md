...
**Resposta:** Valor máximo = 2 (em x = 2)
...
**Resposta:** Al₂O₃ (óxido de alumínio)
...
**Resposta:** Aproximadamente 4,24 s
...
**Resposta:** 0 ≤ x < 10 ou x > 30 unidades
...
**Resposta:** **Polar**. Cl puxa mais os elétrons, formando H^(δ+)─Cl^(δ-).
...
**Resposta:** **c) Força de reação da mesa** (perpendicular à superfície)
...
**Resposta:** 5 m/s² (descendo o plano)
...
**Resposta:** Aproximadamente 3,3 horas
