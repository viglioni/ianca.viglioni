...
const code = "gen-88";
const title = "Geral: Aula 88";
const subject = "geral";
const themes = ["Conjuntos"];
const dates = ["2025-11-18"];
const lessonContent = `<div class="outline-text-3" id="text-5-19">
<ul class="org-ul">
<li>Revisão Leve e Geral</li>
<li>Últimas Dicas</li>
<li>45min</li>
</ul>
</div>
<div id="outline-container-orge2d6a9b" class="outline-4">
<h4 id="orge2d6a9b"><span class="section-number-4">5.19.1.</span> Objetivo</h4>
...
<div id="outline-container-org901dc57" class="outline-3">`;
